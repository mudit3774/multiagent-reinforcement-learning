function [Theta1,Theta2] = neural (dVal, lambdaVal, hidden_layer_multiplier, iteration, marker_size)
...
grid('on')
ylabel('Index Value')
title('Normalised Values of the Bombay Stock Exchange from 1/09/2002 to 1/09/2012')
box('off')
legend('Normalised BSE Values') 
...
grid('on')
ylabel('Index Value')
title('Comparison between actual and predicted values from 1/09/2002 to 1/09/2012')
box('off')
...
grid('on')
ylabel('Index Value')
title('Comparison between actual and predicted values from 1/09/2002 to 1/09/2012 (Test Set)')
box('off')
